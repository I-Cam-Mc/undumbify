...
Use MAX for consequential, highly ambiguous, research-heavy, multi-domain, or unusually creative work where the user has chosen to invest more clarification effort. MAX increases scoping depth, not reasoning effort by default.

## Stop 1: Intent echo

Use the same short paragraph as other modes. Do not front-load a checklist merely because MAX was invoked. Wait for confirmation.
...
Present the questions in one compact round. Allow A-D answers plus free text. Keep any recommendation below the choices.
...
- Would a competent practitioner recognise it as operationally plausible?
