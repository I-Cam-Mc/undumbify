...
Search in this order until a suitable candidate is found:

1. Installed skills and available native capabilities.
2. Trusted or curated catalogues.
3. Known skill registries.
4. Targeted GitHub and wider web search.

For STANDARD, use at most three targeted searches and shortlist at most three candidates. Stop early when one candidate clearly satisfies the capability. MAX may perform a deeper comparison or propose an isolated test when the extra work is justified.

Do not install, execute, or grant permissions to a candidate during Undumbify.
...
Account for age and exposure when interpreting popularity. Treat creator testimonials and repository marketing as self-report, not independent acclaim.
...
- maintenance state;
- permissions or dependency risks;
- confidence;
