...
4. When availability could change the recommendation, verify current official guidance. If that check would cost more than it is worth or is unavailable, label availability as an assumption and give a fallback based on capability.
...
- **Medium:** combining several sources or constraints, bounded research, or non-trivial judgement.
- **High:** difficult work across several fields, high-impact verification, complex systems, or major uncertainty that questions cannot remove.
